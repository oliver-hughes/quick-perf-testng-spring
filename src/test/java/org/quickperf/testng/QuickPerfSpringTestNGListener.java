...
public class QuickPerfSpringTestNGListener implements IInvokedMethodListener {
    ...
    public void beforeInvocation(IInvokedMethod method, ITestResult testResult) {
        TestExecutionContext testExecutionContext = builTestExecutionContextFrom(method);
    ...
    private TestExecutionContext builTestExecutionContextFrom(IInvokedMethod method) {
